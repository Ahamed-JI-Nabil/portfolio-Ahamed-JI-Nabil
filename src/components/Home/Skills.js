...
const Skills = () => {
    return (
        <div className='lg:pb-40 pb-36 lg:px-36 mt-9 static' id='skills'>
            ...
            <div className='grid lg:grid-cols-3 grid-cols-2 gap-4 mt-16'>
                <div class="border border-emerald-500 rounded-md  shadow-xl lg:w-44 w-36 px-6 py-4">
                    <div class="hover:saturate-100 transition ease-in-out delay-150 hover:-translate-y-1 flex-wrap flex justify-center">
