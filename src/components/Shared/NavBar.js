                ...
                <>
                    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                        <div className="relative flex items-center justify-between h-16">
                            ...
                            <a className="hidden lg:block text-left p-2 font-mono text-lg border-solid border-teal-100 hover:border-emerald-400 border-2 rounded-tr-lg rounded-bl-lg mt-3" href='/'>AhamedJINabil</a>
                            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-end">
                                <div className="flex-shrink-0 flex items-center">
                                    <a className="block lg:hidden p-2 font-mono text-lg border-solid border-teal-100 hover:border-emerald-400 border-2 rounded-tr-lg rounded-bl-lg mt-3" href='/'>AhamedJINabil</a>
                            ...
                            {navigation.map((item) => (
                                <Disclosure.Button
                                    ...
                                    className={classNames(
                                        item.current ? 'bg-gray-900' : 'font-mono text-base text-center hover:text-teal-100 block px-3 py-2'
                                    )}
                                >
